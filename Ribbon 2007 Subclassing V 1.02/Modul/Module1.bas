Attribute VB_Name = "Apiler"
' WindowProc Komutlarý
...
Public Const HT_NOTHING    As Long = 0 ' hit-test constants
Public Const HT_TLBUTTON   As Long = 1
Public Const HT_BRBUTTON   As Long = 2
Public Const HT_TLTRACK    As Long = 3
Public Const HT_BRTRACK    As Long = 4
Public Const HT_THUMB      As Long = 5
...
Public Const HTSIZE = 4
Public Const HTCLIENT = 1
Public Const HTVSCROLL = 6
Public Const HTHSCROOL = 7
